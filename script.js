...
// async function getRecentReleases(token) {
//   const result = await fetch('https://api.spotify.com/v1/browse/new-releases', {
//     method: 'GET',
//     headers: { 'Authorization': 'Bearer ' + token }
//   });
...
// async function getDailyMixes(token) {
...
// }
// function displayRecentReleases(releases) {
//   const musicList = document.getElementById('musicList');
//   musicList.innerHTML = '';
//   releases.forEach(release => {
//     const releaseItem = document.createElement('div');
//     releaseItem.classList.add('music-item');
//     const img = document.createElement('img');
...
//     link.target = '_blank';
//     link.textContent = 'Listen on Spotify';
//     releaseItem.appendChild(img);
//     releaseItem.appendChild(title);
//     releaseItem.appendChild(link);
//     musicList.appendChild(releaseItem);
//   });
// }

// function displayDailyMixes(mixes) {
...
//     const img = document.createElement('img');
//     img.src = mix.images[0].url;
//     img.alt = mix.name;
//     const title = document.createElement('h3');
//     title.textContent = mix.name;
//     const link = document.createElement('a');
//     link.href = mix.external_urls.spotify;
//     link.target = '_blank';
//     link.textContent = 'Listen on Spotify';
//     mixItem.appendChild(img);
//     mixItem.appendChild(title);
//     mixItem.appendChild(link);
